...
if __name__ == "__main__":
    ...
    tmp_beta_mat = (tmp_design_mat.T * tmp_design_mat).I * tmp_design_mat.T * tmp_y_mat
    ...
    f_value = f.isf(0.05, df_sse_r - df_sse_f, df_sse_f)
    ...
    f_value = f.isf(0.05, df_sse_r - df_sse_f, df_sse_f)
    ht = tmp_value < f_value
    print("Beta2 = Beta2", [ht, tmp_value, f_value])
